    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 md:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-4 text-sm font-semibold uppercase">Tautan</h2>
              <ul className="text-gray-300">
                <li className="mb-2">
                  <a href="/" className="hover:text-white">Beranda</a>
                </li>
                <li className="mb-2">
                  <a href="/pesan" className="hover:text-white">Pesan</a>
                </li>
              </ul>
            </div>
            
            <div>
              <h2 className="mb-4 text-sm font-semibold uppercase">Dukungan</h2>
              <ul className="text-gray-300">
                <li className="mb-2">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between items-center">
          <span className="text-sm text-gray-300">© 2025 GreenBecak. Hak Cipta Dilindungi.</span>
